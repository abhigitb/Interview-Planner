...
const Interview = () => {
            ...
            <main className='loading-screen'>
                <div className='loading-content'>
                    ...
                    <div className='ai-loader'>
                        <div className='ai-loader__ring'></div>
                        <div className='ai-loader__spark'>✦</div>
                    </div>
                    ...
                    <p className='loading-message'>
                        Preparing your personalized interview strategy...
                    </p>
                    ...
                    <p className='loading-hint'>
                        AI is preparing your interview questions and roadmap
                    </p>
    ...
    return (
        ...
        <div className='interview-page'>
            ...
            {/* ── Resume Generation Loading Overlay ── */}
            {resumeLoading && (
                <div className='resume-loading-overlay'>
                    <div className='resume-loading-card'>
                        ...
                        <p className='loading-hint'>
                            Your resume is being tailored and formatted for you
                        </p>
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    >
                        ...
                        {resumeLoading ? 'Preparing Resume...' : 'Download Resume'}
                    </button>
